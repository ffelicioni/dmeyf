...
for(  tiros_libres  in seq(50,300)) #10, 20, 50, 100, 200,300,400, 415, 460, 600, 700, 1000 
{
#162
  primero_ganador  <- 0

  for( i in 1: 10000)  #diez mil experimentos 10000
  {
    vaciertos <- mapply( ftirar, jugadores, tiros_libres ) 
    #print(vaciertos)
    tb_resultados  <- rbind( tb_resultados, list(vaciertos[6]))
    mejor  <- which.max( vaciertos )
    if( mejor == 6)  primero_ganador <- primero_ganador + 1
  }
