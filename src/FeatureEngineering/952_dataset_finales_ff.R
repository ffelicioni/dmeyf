...
palancas$version  <- "dataset_final"   #Muy importante, ir cambiando la version
...
correr_todo  <- function( palancas )
{
  ...
  cols_promedio<-c("mcaja_ahorro","mactivos_margen","mvr_msaldototal","mv_mlimitecompra")
  if( palancas$promedio3 )  Promedios( dataset, cols_promedio, 3 )
  ...
  cols_ratiomean<-c("Visa_mlimitecompra","Master_mlimitecompra","mvr_msaldototal","mv_mlimitecompra")
  if(palancas$ratiomean6) RatioMean( dataset, cols_ratiomean, 6) #Derivado de la idea de Daiana Sparta
  
  
  #cols_tendencia<-c("mdescubierto_preacordado","ctarjeta_visa","mcuenta_corriente","ccomisiones_mantenimiento","mprestamos_personales")
  cols_tendencia<-campos_buenos  <- c( "mcaja_ahorro", "mtarjeta_visa_consumo", 
                                       "mcuentas_saldo", "mrentabilidad_annual", "mprestamos_personales", "mactivos_margen", "mpayroll",
                                       "mv_mpagominimo","chomebanking_transacciones", "mv_msaldopesos",
                                       "mrentabilidad", "mv_msaldototal", "mcuenta_corriente",
                                       "mv_mpagospesos", "mcomisiones_mantenimiento",
                                       "mtransferencias_recibidas", "mv_mfinanciacion_limite",
                                       "mcaja_ahorro_dolares", "mcomisiones_otras", "mcuenta_debitos_automaticos",
                                       "mcomisiones", "ccomisiones_otras", "mtransferencias_emitidas",
                                       "mpagomiscuentas","mvr_msaldototal","mv_mlimitecompra","mvr_mconsumospesos")
