...
pdf("./work/zeroes_ratio_continuan.pdf")
...
pdf("./work/nas_ratio_continuan.pdf")
for( campo in  campos_buenos )
{
...
pdf("./work/promedios_continuan.pdf")
for( campo in  campos_buenos )
{
...
#pdf("./work/promedios_nocero_continuan.pdf")
#for( campo in  campos_buenos )
#{
...
pdf("./work/medianas_continuan.pdf")
for( campo in  campos_buenos )
{
...
pdf("./work/quantile_25_continuan.pdf")
for( campo in  campos_buenos )
{
...
pdf("./work/quantile_75_continuan.pdf")
for( campo in  campos_buenos )
{
...
pdf("./work/quantile_10_continuan.pdf")
for( campo in  campos_buenos )
{
...
pdf("./work/quantile_90_continuan.pdf")
for( campo in  campos_buenos )
{
