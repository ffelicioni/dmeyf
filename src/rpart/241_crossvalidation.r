...
ksemillas  <- c(100003, 101207, 103577, 103457, 104089) #c(102191, 200177, 410551, 552581, 892237) #reemplazar por las propias semillas
#ksemilla_extra  <- 104717#950009  #reemplazar por una elegida en el momento
